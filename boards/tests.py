...
#     topic = Topic.objects.create(subject='Hello everyone!', board=board, starter=user)
#     post = Post.objects.create(message='This is my first topic.. :-)', topic=topic, created_by=user)

# create_instances_model()
